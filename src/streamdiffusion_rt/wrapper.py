...
class StreamDiffusionWrapper:
    ...
    def _load_model(
        ...
        vae_id : Optional[str], optional
            The vae_id to load, by default None.
        acceleration : Literal["none", "xformers", "tensorrt"], optional  # FORK: sfast removed
            The acceleration method, by default "tensorrt".
        warmup : int, optional
            The number of warmup steps to perform, by default 10.
        do_add_noise : bool, optional
        ...
        try:
            ...
            if acceleration == "tensorrt":
                ...
                from streamdiffusion_rt.acceleration.tensorrt.engine import (
                    AutoencoderKLEngine,
                    UNet2DConditionModelEngine,
                )
                from streamdiffusion_rt.acceleration.tensorrt.models import (
                    VAE,
                    UNet,
                    VAEEncoder,
                )
            ...
            # FORK: sfast acceleration removed - use tensorrt instead
        except Exception:
            traceback.print_exc()
